...
| --- | --- |
| Isolated identity profiles and installed-Codex launch | Implemented, including guided first-profile setup from the plain command, existing-home adoption with valid sign-in reuse, resumable Pending profiles, a keyboard picker, and foreground Codex launch through the persistent companion; real-account platform qualification has documented exceptions |
