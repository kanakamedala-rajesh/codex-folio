...
export const alertsCopy = {
  ...
  subtitle:
    "Actionable conditions from normalized local evidence. Missing data never becomes a capacity warning.",
  views: "Alert views",
  active: "Active",
  history: "History",
  noActive: "No active operational conditions.",
  noHistory: "No retained alert history.",
  allProfiles: "All profiles",
  remaining: "remaining",
  windowEnd: "Reported reset",
  lastSeen: "Last observed",
  ...
  thresholdDetail:
    "Defaults are 20% warning and 10% critical remaining. Settings apply to one Identity Profile and provider window.",
  profile: "Identity Profile",
  window: "Provider window",
  primary: "Primary window",
  secondary: "Secondary window",
  warning: "Warning remaining · percent",
  critical: "Critical remaining · percent",
...
export const telemetryCopy = {
  title: "Optional telemetry",
  unavailable: "Off · Enablement unavailable",
  disabled: "Off · Awaiting explicit consent",
  enabled: "On · Explicit consent recorded",
  inspect: "Inspect public schema and prerequisites",
  publicSchema: "Public event schema",
  consentSchema: "Consent schema",
  retention: "Published retention",
  days: "days for individual events",
  months: "months for anonymous aggregates",
  allowed: "Allowed fields",
  excluded: "Always excluded",
  features: "Coarse features",
  outcomes: "Outcomes",
  platforms: "OS families and architectures",
  durationBuckets: "Duration buckets",
  installationId: "Random installation ID",
  present: "Present (value is never displayed)",
  absent: "Not created",
  prerequisites: "Operational prerequisites",
  endpoint: "Project HTTPS endpoint",
  schema: "Public schema",
  notice: "Privacy notice",
  eventRetention: "30-day event deletion job",
  aggregateRetention: "13-month aggregate deletion job",
  deletion: "Deletion operation",
  reset: "Reset operation",
  ready: "Ready",
  missing: "Missing",
  enable: "Consent and enable schema",
  revoke: "Revoke consent",
  resetId: "Reset installation ID",
  enabledMessage: "Telemetry consent recorded for this schema version.",
  revokedMessage: "Telemetry consent revoked immediately.",
  resetMessage: "The random installation ID was reset.",
  failed: "Telemetry was not changed. Local features remain available.",
} as const;
